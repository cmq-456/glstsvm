function [label_new, iter_GMM, responsivity ,Class,para_miu, para_sigma,para_pi, NegativeLogLikelihood, fitness]=GMM_kailugaji(X, K, label_old)
% Input:
% K: number of cluster
% X: dataset, N*D
