...
class OneVsOneClassifier(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X_train, y_train, W):     
        ...
        y_train = self._validate_targets(y_train)
        ...
        for i in range(self.classes_.size):                
            ...
            for j in range(i + 1, self.classes_.size):      
                ...
                sub_prob_X_i_j = X_train[(y_train == i) | (y_train == j)]
                sub_prob_y_i_j = y_train[(y_train == i) | (y_train == j)]
                ...
                self.bin_clf_[p].fit(Wi,Wj,sub_prob_X_i_j, sub_prob_y_i_j)  

                p = p + 1

        self.shape_fit_ = X_train.shape
